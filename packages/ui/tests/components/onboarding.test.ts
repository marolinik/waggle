...
describe('onboarding component exports', () => {
  it('exports OnboardingWizard as a function', () => {
    expect(typeof OnboardingWizard).toBe('function');
  });

  it('exports NameStep as a function', () => {
    expect(typeof NameStep).toBe('function');
  });

  it('exports ApiKeyStep as a function', () => {
    expect(typeof ApiKeyStep).toBe('function');
  });

  it('exports WorkspaceStep as a function', () => {
    expect(typeof WorkspaceStep).toBe('function');
  });

  it('exports ReadyStep as a function', () => {
    expect(typeof ReadyStep).toBe('function');
  });
});
